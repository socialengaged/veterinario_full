...
class Specialist(Base):
    ...
    phone: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    phone_fixed: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    phone_mobile: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    ...
    import_batch: Mapped[Optional[str]] = mapped_column(String(64), nullable=True, index=True)
    is_active: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
