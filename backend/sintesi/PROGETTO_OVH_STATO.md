...
| **Checkpoint rollback** | Tag **`checkpoint/ovh-2026-03-30-pre-dashboard-footer-requests`** → commit **`8a92d71`** (stato immediatamente prima della release footer/richieste) |
