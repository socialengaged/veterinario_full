...
- **Checkpoint rollback (stato buono):** tag Git **`checkpoint/ovh-2026-04-01-email-cc-verified`** (SHA commit: `git rev-parse checkpoint/ovh-2026-04-01-email-cc-verified^{commit}` dopo `git fetch`). Produzione verificata: notifiche admin **To+Cc**, form generico e consulenza online.
